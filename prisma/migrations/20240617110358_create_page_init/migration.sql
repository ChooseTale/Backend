...
*/
-- CreateEnum
CREATE TYPE "Janre" AS ENUM ('FANTASY', 'SCI_FI', 'HORROR', 'MYSTERY', 'ROMANCE', 'THRILLER', 'HISTORICAL', 'WESTERN', 'DYSTOPIA', 'SATIRE', 'BIOGRAPHY', 'AUTOBIOGRAPHY', 'ESSAY', 'DRAMA', 'POETRY', 'COMIC', 'NON_FICTION', 'FICTION', 'OTHER');
...
CREATE TABLE "Game" (
    ...
    "janre" "Janre" NOT NULL DEFAULT 'OTHER',
    "thumbnailId" INTEGER,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "deletedAt" TIMESTAMP(3),
